...
class ColorPalette(Gtk.Box):
    def __init__(self, color_picker: ColorPicker):
        ...
        colors = [
            ...
            (255, 217, 180),  # Светло-оранжевый
            (255,255,180),    # Светло-желтый

            (180,255,180),    # Светло-зеленый
            (180, 255, 255),  # Светло-голубой
            (180,180,255),    # Светло-синий

            (255,180,255),    # Светло-фиолетовый
            (255,255,255),    # Белый
            (255, 0, 0),      # Красный
